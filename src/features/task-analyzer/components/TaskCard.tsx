        ...
        return (
          <>
            ...
            <CardContent className="pt-0">
              <p className="text-sm text-muted-foreground italic font-bold mb-4">
                {analysis.rationale}
              </p>
              ...
              <div className="bg-muted/50 p-3 rounded-lg mb-4 border">
                ...
                <p className="font-medium text-sm">{taskData.task}</p>
              </div>
                ...
                <div>
                  ...
                  {isDetailsVisible && (
                    <div className="mt-3 pl-4 border-l-2 border-primary/20 space-y-3 text-sm text-muted-foreground">
                      ...
                      {taskData.action && taskData.pointType !== "R2" && (
                        <div>
                          <strong className="font-semibold text-foreground">
                            Action Item:
                          </strong>{" "}
