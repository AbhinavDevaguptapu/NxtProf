    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-3xl font-bold tracking-tight">Add Learning Points</h1>
                    <p className="text-muted-foreground">Log your learning activities and manage attendance.</p>
                </div>
            </div>
