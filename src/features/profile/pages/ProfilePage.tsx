    ...
    try {
      ...
      if (profileImageFile) {
        const storageRef = ref(
          storage,
          `avatars/${user.uid}/${profileImageFile.name}`
        );
    ...
    >
      <Card className="max-w-2xl mx-auto">
        <CardHeader>
          ...
          <CardDescription>
            Manage your personal and application-specific information.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Input
              id="sheetUrl"
              value={feedbackSheetUrl}
              onChange={(e) => setFeedbackSheetUrl(e.target.value)}
              disabled={isSaving}
            />
          </div>
        </CardContent>
