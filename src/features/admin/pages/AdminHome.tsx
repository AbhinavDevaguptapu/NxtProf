      ...
      >
        <div>
          ...
          <p className="text-base text-muted-foreground mt-1">
            Welcome back, {admin?.email?.split("@")[0] || "Admin"}. Here&rsquo;s
            your daily overview.
          </p>
        </div>
      </motion.header>
        ...
        <div className="lg:col-span-2 space-y-6 lg:space-y-8">
          ...
          >
            ...
            <motion.div variants={itemVariants}>
              <StatCard
                title="Learning Hour"
                value={learningHourTime || "Not Set"}
                icon={GraduationCap}
                color={"blue"}
              />
            </motion.div>
          ...
          >
            ...
            <motion.div variants={itemVariants}>
              <AttendanceCard
                ...
                totalCount={employeeCount}
                onActionClick={() => setActiveView({ view: "learning-hours" })}
                color={"green"}
              />
            </motion.div>
          </motion.div>
      ...
      <CardContent className="pt-2">
        ...
        <div className="mt-2 space-y-1">
          ...
          <span className="text-xs font-medium text-muted-foreground">
            {percentage}% of employees were present.
          </span>
        </div>
      </CardContent>
    </Card>
...
const QuickActionButton = ({
  ...
  <button
    onClick={onClick}
    className="flex items-center gap-3 w-full p-2 rounded-md text-sm font-medium text-muted-foreground transition-colors hover:text-foreground hover:bg-muted"
  >
    <Icon className="h-5 w-5" />
    <span>{label}</span>
...
const ActionAlert = ({
  ...
  <Alert
    variant="default"
    className="border-amber-300 dark:border-amber-800/50 bg-amber-50/50 dark:bg-amber-950/20"
  >
    ...
    <AlertDescription className="mt-1 text-amber-700 dark:text-amber-400">
      Some daily sessions are not scheduled. Set them up to keep your team on
      track.
    </AlertDescription>
