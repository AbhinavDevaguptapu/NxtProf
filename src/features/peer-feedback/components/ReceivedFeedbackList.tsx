...
const ReceivedFeedbackList = ({
  ...
  const filteredFeedback = useMemo(() => {
    ...
    return feedback.filter(
      (item) => format(parseISO(item.submittedAt), "yyyy-MM") === selectedMonth
    );
  }, [feedback, selectedMonth]);

  const overallRating = useMemo(
    () => calculateOverallRating(filteredFeedback),
    [filteredFeedback]
  );
    ...
    return (
      <div className="text-center text-muted-foreground py-12">
        ...
        <p className="mt-2 text-sm">
          It looks like you haven&rsquo;t received any feedback yet.
          <br />
        ...
        <div>
          ...
          {selectedMonth && (
            <p className="text-sm text-muted-foreground">
              ...
              star rating from {overallRating.totalEntries} entries.
            </p>
          )}
        </div>
          ...
          <div className="space-y-4">
            {filteredFeedback.length > 0 ? (
              ...
              <div className="text-center text-muted-foreground py-12">
                ...
                <p className="mt-2 text-sm">
                  It looks like you haven&rsquo;t received any feedback for this
                  month.
                </p>
              </div>
            )}
