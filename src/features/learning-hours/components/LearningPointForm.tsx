...
type LearningPointFormProps = {
  ...
  onClose: () => void;
  onSubmit: (
    data: Omit<z.infer<typeof formSchema>, "date"> & { date: Timestamp }
  ) => void;
  defaultValues?: Partial<LearningPoint>;
};

// --- COMPONENT ---
export const LearningPointForm = ({
  isOpen,
  onClose,
  onSubmit,
  defaultValues,
}: LearningPointFormProps) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent
        ...
        className="max-w-md md:max-w-3xl h-[90vh] overflow-y-auto"
      >
        <DialogHeader>
          <DialogTitle>
