    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel className="whitespace-normal leading-tight block">
                Task in the Day{" "}
            ...
            <FormItem>
              ...
              <Select onValueChange={field.onChange} defaultValue={field.value}>
                ...
                <SelectContent position="popper">
                  ...
                  <SelectItem value="Efficiency and Creativity">
                    Efficiency and Creativity
                  </SelectItem>
                  <SelectItem value="Task Review">
                    Task Review and Reporting
                  </SelectItem>
                  <SelectItem value="Growth Mindset">Growth Mindset</SelectItem>
                  <SelectItem value="Outcome vs Output">
                    Outcome vs Output
                  </SelectItem>
                  <SelectItem value="Being Organized">
                    Being Organized
                  </SelectItem>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input
                  placeholder="e.g., https://github.com/pull/123"
                  {...field}
                />
              </FormControl>
              <FormMessage />
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Textarea placeholder="Describe the behavior..." {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
